...
<div style="font-family: Arial, sans-serif; color: #333;">
    ...
    <a href="https://fly-express.onrender.com/" style="display: inline-block; margin-top: 20px; padding: 12px 24px; 
...
export function sendWelcomeEmail(toEmail) {
    ...
    if (!emailRegex.test(toEmail)) {
        console.log('📧 User did not provide an email. Skipping welcome email.');
        return;
    }
